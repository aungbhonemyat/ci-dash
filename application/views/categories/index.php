					...
					<div class="container">
							...
							<div class="container pt-3">
											...
											<?php if (!empty($categories)) {
												foreach ($categories as $categ) { ?>
													<tr>
														...
														<td>
															<a href="<?php echo base_url() . 'index.php/categories/edit/' . $categ['id'] ?>" class="text-info" style="margin-right: 20px;"><i class="fa-regular fa-pen-to-square"></i></a>
															<a href="<?php echo base_url() . 'index.php/categories/delete/' . $categ['id'] ?>" class="text-danger mr-2"><i class="fa-regular fa-trash-can"></i></a>
														</td>
													</tr>
												<?php }
											} else { ?>
								...
								<div class="col-md-12 d-flex justify-content-end">
									<a href="<?php echo base_url() . 'index.php/categories/create' ?>" class="btn btn-danger">Create</a>
								</div>
							</div>
					</div>
				</div>
