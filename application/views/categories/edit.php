							...
							<div class="col-lg-5">
								<div class="card shadow-lg border-0 rounded-lg mt-2">
									<div class="card-header">
										<h3 class="text-center font-weight-light my-4">Edit Categories</h3>
									</div>
									<div class="card-body">
										<form method="post" action="<?php echo base_url().'index.php/categories/edit/'.$category['id']; ?>">
											<div class="form-floating mb-3">
												<input class="form-control" id="inputName" type="text" name="name" value="<?php echo set_value('name',$category['name'])?>" required />
												<label for="inputName">Item Name</label>
												<small class="text-danger"><?php echo form_error('name'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="description" type="text" name="description" value="<?php echo set_value('description',$category['description'])?>" required />
												<label for="description">Description</label>
												<small class="text-danger"><?php echo form_error('description'); ?></small>
											</div>
											<div class="d-flex align-items-center justify-content-between mt-4 mb-0">
												<a class="btn btn-primary mt-4" href="<?php echo base_url() . 'index.php/categories/index' ?>">Back</a>
