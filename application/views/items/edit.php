					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								...
								<a class="nav-link" href="<?php echo base_url() . 'index.php/categories/index' ?>">Static Navigation</a>
							...
							<div class="col-lg-5">
								<div class="card shadow-lg border-0 rounded-lg mt-2">
									<div class="card-header">
										<h3 class="text-center font-weight-light my-4">Edit Item</h3>
									</div>
									<div class="card-body">
										<form method="post" action="<?php echo base_url().'index.php/items/edit/'.$items['id']; ?>" enctype="multipart/form-data">
											<div class="form-floating mb-3">
												<input class="form-control" id="inputName" type="text" name="name" value="<?php echo set_value('name',$items['name'])?>" required />
											...
											<div class="form-floating mb-3">
												<input class="form-control" id="description" type="text" name="description" value="<?php echo set_value('description',$items['description'])?>" required />
												<label for="description">Description</label>
												<small class="text-danger"><?php echo form_error('description'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="price" type="number" name="price" value="<?php echo set_value('price',$items['price'])?>" required />
												<label for="price">Price</label>
												<small class="text-danger"><?php echo form_error('price'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="quantity" type="number" name="stock_quantity" value="<?php echo set_value('stock_quantity',$items['stock_quantity'])?>" required />
											...
											<select class="form-control mb-3" id="category_id" name="category_id">
												<?php foreach ($categories as $category): ?>
													<option value="<?php echo $category['id']; ?>" <?php echo ($category['id'] == $items['category_id']) ? 'selected' : ''; ?>><?php echo $category['name']; ?></option>
												<?php endforeach; ?>
											</select><br>
