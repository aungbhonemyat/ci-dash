								...
								<div class="card-body">
									<form action="<?php echo base_url() . 'index.php/login'; ?>" method="post">
										...
										<div class="form-check mb-3">
											<input type="checkbox" class="password-toggle-checkbox" id="showPassword" onclick="togglePasswordVisibility()">
											<label for="showPassword">Show Password</label>
										</div>
										<div class="d-flex align-items-center justify-content-between mt-4 mb-0">
											<a class="btn btn-primary mt-4" href="<?php echo base_url().'index.php/items/index';?>">Back</a>
											<a class="small mt-4" href="<?php echo base_url() .'index.php/forgotPassword';?>">Forgot Password?</a>
											<button type="submit" class="btn btn-primary mt-4">Login</button>
										</div>
									</form>
								</div>
								<div class="card-footer text-center py-3">
									<div class="small"><a href="<?php echo base_url('index.php/register') ?>">Need an account? Sign up!</a></div>
								</div>
							</div>
						</div>
					</div>
