<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="index.html">Authorize User Section</a>
		<!-- Sidebar Toggle-->
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="<?php echo base_url() . 'index.php/items/index' ?>">Shopping here!</a>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4"><i class="fas fa-user fa-circle-user"></i>
...
<!-- <div class="navbar-nav p-3">
	<a class="nav-link text-white" href="<?php echo base_url('index.php/dashuser/index') ?>">User dash</a>
	<a class="nav-link text-white" href="<?php echo base_url('index.php/dash/index') ?>">Admin dash</a>
	<?php if (!$this->session->has_userdata('authenticated')) { ?>
		<a class="nav-link text-white" href="<?php echo base_url('index.php/register') ?>">Register</a>
		<a class="nav-link text-white" href="<?php echo base_url('index.php/login') ?>">Login</a>
	<?php } ?>
</div> -->
