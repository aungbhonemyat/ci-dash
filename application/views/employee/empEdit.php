							...
							<div class="col-lg-5">
								<div class="card shadow-lg border-0 rounded-lg mt-2">
									<div class="card-header">
										<h3 class="text-center font-weight-light my-4">Edit Employee</h3>
									</div>
									<div class="card-body">
										<form method="post" action="<?php echo base_url().'index.php/employee/edit/'.$employee['id']; ?>">
											<div class="form-floating mb-3">
												<input class="form-control" id="inputFirstName" type="text" name="first_name" value="<?php echo set_value('fist_name',$employee['first_name'])?>" required />
												<label for="inputFirstName">First Name</label>
												<small class="text-danger"><?php echo form_error('first_name'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="inputLastName" type="text" name="last_name" value="<?php echo set_value('last_name',$employee['last_name'])?>" required />
												<label for="inputLastName">Last Name</label>
												<small class="text-danger"><?php echo form_error('last_name'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="email" type="text" name="email" value="<?php echo set_value('email',$employee['email'])?>" required />
												<label for="email">Email</label>
												<small class="text-danger"><?php echo form_error('email'); ?></small>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="password" type="text" name="password" value="<?php echo set_value('passwrod',$employee['password'])?>" required />
											...
											<select class="form-control mb-3" id="employee_id" name="role_as">
												<?php foreach ($roles as $roleId => $roleName): ?>
													<option value="<?php echo $roleId; ?>" <?php echo ($roleId == $employee['role_as']) ? 'selected' : ''; ?>><?php echo ucfirst($roleName); ?></option>
												<?php endforeach; ?>
											</select>

											<div class="d-flex align-items-center justify-content-between mt-4 mb-0">
												<a class="btn btn-primary mt-4" href="<?php echo base_url() . 'index.php/employee/index' ?>">Back</a>
